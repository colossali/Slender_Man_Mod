...
/*					if (this.entityToAttack instanceof EntityPlayer && this.getDistancetoEntityToAttack() <= 5.0D)
	...
	private boolean isInFieldOfVision(EntitySlenderMan var1, EntityPlayer var17, float var3, float var4)
	{
		float var5 = var17.rotationYaw;
		float var6 = var17.rotationPitch;
		var17.faceEntity(var1, 360.0F, 360.0F);
		float var7 = var17.rotationYaw;
		float var8 = var17.rotationPitch;
		var17.rotationYaw = var5;
		var17.rotationPitch = var6;
		float var11 = var17.rotationYaw - var3;
		float var12 = var17.rotationYaw + var3;
		float var13 = var17.rotationPitch - var4;
		float var14 = var17.rotationPitch + var4;
		boolean var15 = this.GetFlag(var11, var12, var7, 0.0F, 360.0F);
		boolean var16 = this.GetFlag(var13, var14, var8, -180.0F, 180.0F);
		return var15 && var16 && (var17.canEntityBeSeen(var1) || this.LineOfSightCheck(var17));
