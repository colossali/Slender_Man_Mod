...
public class GuiScreenResetWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_96154_o = new GuiButton(1, this.width / 2 - 100, this.height / 4 + 96 + 12, stringtranslate.translateKey("mco.configure.world.buttons.reset")));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 120 + 12, stringtranslate.translateKey("gui.cancel")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
                TaskResetWorld taskresetworld = new TaskResetWorld(this, this.field_96150_b.field_96408_a, this.field_96151_c.getText());
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, stringtranslate.translateKey("mco.reset.world.title"), this.width / 2, 17, 16777215);
        this.drawCenteredString(this.fontRenderer, stringtranslate.translateKey("mco.reset.world.warning"), this.width / 2, 66, 16711680);
        this.drawString(this.fontRenderer, stringtranslate.translateKey("mco.reset.world.seed"), this.width / 2 - 100, 96, 10526880);
