...
public abstract class GuiScreenSelectLocation
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
            ...
            if (this.field_104102_m == -1.0F)
            {
                ...
                if (par2 >= this.field_104098_a && par2 <= this.field_104096_b)
                {
                    ...
                    if (par1 >= l && par1 <= i1)
                    {
                        ...
                        i2 = (int)((float)((this.field_104096_b - this.field_104098_a) * (this.field_104096_b - this.field_104098_a)) / (float)this.getContentHeight());
        ...
        if (j2 > 0)
        {
            i2 = (this.field_104096_b - this.field_104098_a) * (this.field_104096_b - this.field_104098_a) / this.getContentHeight();
