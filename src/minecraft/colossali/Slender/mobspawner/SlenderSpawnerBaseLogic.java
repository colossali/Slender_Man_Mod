...
public abstract class SlenderSpawnerBaseLogic
{
    /** The delay to spawn. */
    public int spawnDelay = 8000;
    private String mobID = "Zombie";
    ...
    private int activatingRangeFromPlayer = 299;
    ...
    public void updateSpawner()
    {
        if (this.canRun())
        {
            ...
            else
            {
                ...
                {
                    Entity entity = EntityList.createEntityByID(123, this.getSpawnerWorld());
